...
<div class="jumbotron mt-5">
    <h2 class="display-5">Hasil entri data Destinasi Baru</h2>
</div>
                ...
                <tbody>
                    ...
                    if(isset($_POST["kirim"]))
                    {
                        ...
                        $query = mysqli_query($connection, "select * 
                            from sandra, destinasi
                            where sandraKOTA like '%".$search."%' AND destinasi.destinasiKODE = sandra.sandraID"); //ini diambil dari dua tabel
                    }else

                    {
                        //akan membuat dia tidak redudansi
                        $query = mysqli_query($connection, "select * from sandra, destinasi
                        WHERE destinasi.destinasiKODE = sandra.sandraID");
                    }
